...
class PetManagementViewModel(
            ...
            try {
                ...
                uiState =
                    uiState.copy(
                        ...
                        reminderBaseUrl = settings.reminderBaseUrl,
                    )
            } catch (e: Exception) {
    ...
    fun onReminderBaseUrlChanged(url: String) {
        uiState = uiState.copy(reminderBaseUrl = url, message = null)
    }
            ...
            try {
                val settings =
                    FeedingSettings(
                        ...
                        reminderBaseUrl = uiState.reminderBaseUrl,
                    )
